// Generated by Wrangler by running `wrangler types` (hash: dbb568642708682f4f7a14555a0f7cbd)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_OPENAI_URL" | "AI_GATEWAY_GROQ_URL" | "OPENAI_API_KEY" | "GROQ_API_KEY" | "BRAVE_API_KEY" | "FIRECRAWL_API_KEY" | "APP_URL" | "BETTER_AUTH_SECRET" | "EMAIL_SENDER" | "RESEND_API_KEY" | "MOCK_SEND_EMAIL">> {}
}
declare module "*.sql" {
	const value: string;
