// Generated by Wrangler by running `wrangler types` (hash: 6939f0126a5c16f67c6b16e419ef3d29)
...
declare namespace Cloudflare {
	interface Env {
		...
		CHAT_DURABLE_OBJECT: DurableObjectNamespace<import("./src/server/index").ChatDurableObject>;
		AGENT_DURABLE_OBJECT: DurableObjectNamespace<import("./src/server/index").AgentDurableObject>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_OPENAI_URL" | "AI_GATEWAY_GROQ_URL" | "AI_GATEWAY_GEMINI_URL" | "OPENAI_API_KEY" | "GROQ_API_KEY" | "GEMINI_API_KEY" | "BRAVE_API_KEY" | "FIRECRAWL_API_KEY" | "APP_URL" | "BETTER_AUTH_SECRET" | "EMAIL_SENDER" | "RESEND_API_KEY" | "MOCK_SEND_EMAIL">> {}
}
declare module "*.sql" {
	const value: string;
